...
const Carrito = ({ onClose }) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          ...
          .catch(() => Swal.fire("Error al vaciar el carrito", "", "error"));
      }
    });
  };
  ...
  const eliminarProductoCarrito = (item) => {
    ...
    axios
      ...
      .catch(() => Swal.fire("Error al eliminar el producto", "", "error"));
  };
        ...
        <div className="px-5 py-3 flex-1 overflow-y-auto">
          {carrito.length === 0 ? (
            ...
            carrito.map((item, index) => {
              ...
              return (
                <div key={index} className="flex items-start gap-4 py-4 border-b">
                  <img
